...
class ProductsController extends Controller
{
    ...
    public function showProductFeatures($slug)
    {
        ...
        if ($slug == 'essential-premier') {

            switch ($country) {
                case 'in':
                    return view('product.essential.Premier.feature_hk_en', compact('product'));
                    break;
            }
        }
    ...
    */
    ...
    public function showProductSpec($slug)
    {
        ...
        if ($slug == 'essential-premier') {
            ...
            switch ($country) {
                case 'in':
                    return view('product.essential.Premier.spec_hk_en', compact('product'));
                    break;
            }
        }
