    ...
    <main class="top-nav-padding">
                ...
                <a href="https://www.amazon.in/s?k=avita+pura">
                    <div class="banner-block responsive-item">
                        <div class="banner-bg hidden-sm-down"
                            style="background-image: url('/images/pura/AW_PURA_1920x720sg.jpg')"></div>
                        <div class="banner-bg hidden-md-up"
                            style="background-image: url('/images/pura/AW_PURA_991x1050sg .jpg')"></div>
            ...
            <div class="container" style="text-align:center;">
                ...
                <div class="banner-para">
                    <div align="center" class="col-lg-12">
                        ...
                        <span class="buy-now2"><a href="">Buy Now</a></span>
                    </div>
                    ...
                    <div class="banner-para text-center">
                        <span class="d-lg-block">
                            ...
                            <a href="https://www.nexstmall.com/en_hk/avita.html/cto/avita-pura-laptop?___store=en_hk&utm_source=brandsitepuraproductpage&utm_medium=web&utm_campaign=puraLaunchPhase1&utm_content=overviewpage"
                                target="_blank" style="color:#09F">Buy now ></a>&nbsp;&nbsp;
        ...
        <section class="admiror-video" style="background-color:#fff;">
            <div class="banner-block">
                <div class="container">
                    <div class="space30"></div>
                    <iframe id="ytplayer" type="text/html" width="1110" height="630"
                        src="/videos/PURA_clean_version2.mp4?controls=1&rel=0&showinfo=0&autoplay=1&loop=1&mute=1"
        ...
        <section class="product-liber-computer ls-0" id="test" style="background-color:#eee;">
            <div class="container">
                <div class="banner-info">
                    <div class="space60"></div>
                    <div class="h2 banner-header mb-4 mb-sm-5" style="text-transform:uppercase;">Simplicity at its best
                    </div>
                    <div class="banner-para">
                ...
                <div class="container">
                    <div class="banner-info ls-0" style="text-align:left">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">The all-new AVITA PURA cleverly packs powerful functionalities
                                inside a clean and sleek body design that is like no others. Forget the clumsiness of
                                conventional laptop computers and welcome to a world of new experience!</span>
                            <span class="d-lg-block"><a href="{{ route('product.spec', 'pura') }}"
                        ...
                        <div
                            ...
                            <div class="data-card my-3 text-left">
                                ...
                                <div class="badge-caption"><a
                                        href="https://support.microsoft.com/en-in/help/4020089/windows-10-in-s-mode-faq"
                            ...
                            <div class="data-card my-3 text-left">
                                ...
                                <div class="badge-caption">CORE<sup>&trade;</sup> i3-8145U / i5-8265U | AMD A9-9420E /
                                    R3-3200U / R5-3500U </div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="banner-block ls-0">
                <div class="banner-bg hidden-sm-down"
                    style="background:url(/images/pura/pura_bg3.jpg) top center no-repeat;"></div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6" align="left">
                            ...
                            <div class="banner-para ls-0">
                                The 35.56 cm AVITA PURA embraces a super slim outfit and weighs from a mere 1.21 kg,
                                offering you unparalleled portability and ease of use.</span> </div>
        ...
        <section>
            <div class="banner-block">
                <div class="banner-bg hidden-sm-down"
                    style="background:url(/images/pura/pura_bg2.jpg) top center no-repeat;"></div>
                <div class="container">
                    <div class="space60 hidden-sm-down"></div>
                    <div class="space60"></div>
                    <div class="row">
                        <div class="col-12 col-lg-6" align="left">
                            ...
                            <div class="space60 hidden-sm-down"></div>
                            <div class="banner-para ls-0">
                                No more agonising wait for the laptop to power up! The AVITA PURA is the perfect example of
                                modern computing and could turn on in as soon as 20 seconds, so you can hop on anytime to
                                flex your creativity - in a lightning fast manner. Thanks to the extended battery life that
                                lasts up to 10 hours*, the AVITA PURA is the perfect companion to have your work and life
                                seamlessly combined.<br />
                                <br />
                                The AVITA PURA is pre-installed with the Windows 10 Home Edition operating system (in S
                                mode), along with the 8th-generation Intel® Core™ i3-8145U or i5-8265U processor, up to 8GB
                                RAM, 512GB SSD hard disk and various ports to meet your everyday needs.</span>
                            </div>
                        </div>
                    </div>
                    <div class="space60 hidden-sm-down"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8" align="center">
                        ...
                        <div class="space60"></div>
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">Every piece of detail on the AVITA PURA has been carefully thought
                                through to ensure the best possible experience for you. While the re-engineered keyboard
                                could enhance your work efficiency, the non-slip cover effectively reduces the risks of
                                falling or impact to the device.</span>
                        </div>
                    </div>
                </div>
                <div class="space60 hidden-sm-down"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8" align="center">
                        ...
                        <div class="banner-para ls-0 py-3">
                            <span class="d-lg-block">Pre-installed Windows 10 (S Mode). Windows 10 in S mode is a
                                version of Windows 10 that's streamlined for the best performance, while providing a fast
                                startup and long life battery. To increase security, it allows apps from the Microsoft
                                Store, and requires Microsoft Edge for safe browsing. It's available to switch from S mode
                                to Windows 10 as your preference.
                            </span>
                            <span class="d-lg-block  py-3">
                                <a href="https://support.microsoft.com/en-in/help/4020089/windows-10-in-s-mode-faq"
                                    style="color:#09F" target="_blank">How to switch to Windows 10 Home Edition for
                                    free　></a>
                            </span>
                            <span class="d-lg-block  mb-3">
                                <small>
                                    *Switch out of S mode is an one-way action. You will not be able to revert to the S
                                    mode.
                                </small>
                            </span>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8  Fadein" align="center">
                        ...
                        <div class="space60"></div>
                        <div class="banner-para ls-0">
                            <span class="d-lg-block mx-3">The AVITA PURA comes with a complimentary notebook 3-in-1
                                computer sleeve that can be used as a handy carrying case or a stylish carrying bag for your
                                personal belongings. What's more, the soft and slouchy premium sleeve sports a choice of six
                                colours, grey, green, orange, blue, black and purple, to suit your style. </span>
