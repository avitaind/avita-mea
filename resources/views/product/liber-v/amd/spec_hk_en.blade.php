                    ...
                    <nav class="nav nav-pills nav-product-spec justify-content-center">
                        ...
                        <a class="col text-center nav-link active" data-toggle="tab" href="#spec-140" role="tab">
                            <div class="spec-item-name mb-12">
                                <div class="d-sm-block">AVITA LIBER V</div>
                            ...
                            <ul
                                ...
                                <li style="background-color: #ff6082" class="active"
                                    data-image="/images/liber-v/ff6082.png"></li>
                    ...
                    <div class="container">
                        ...
                        <ul class="list-unstyled spec-list">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>14 16:9 Full HD (1920 x 1080) Anti-Glare IPS Panel with 178 degree wide viewing angle
                                    <!-- Anti-Glare IPS Panel with 178 degree wide viewing angle -->
                                </div>
                            </li>
                            <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">@lang('prod_spec.memory')</div>
                                <div>8 GB DDR4 2400MHz</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>2 x USB 3.0, 1 x USB 3.0 Type-C (PD 3.0 charging, Display out), 1 x 3.5mm Headphone
                                    Jack, DC in, 1 x MicroSD card slot, 1 x HDMI Type A</div>
                            </li>
                            <li class="spec-item d-flex">
                            ...
                            <li class="spec-item d-flex">
                                ...
                                <div>Soft Lavender, Summer Pink, Azure Blue, Charming Red, Unicorn Gold, Star Silver,
                                    Infinite Black, Shinning White, Original Purple, Anchor Grey
                                    <br/>(14+ colours are coming soon, please stay close to our updates)</div>
                            </li>
                            {{-- <li class="spec-item d-flex">
                            ...
                            {{-- <li class="spec-item d-flex">
                                <div class="offset-md-1 col-4 col-md-3">@lang('prod_spec.warranty')</div>
                                <div>2 years</div>
                            </li> --}}
                        </ul>
                    </div>
