...
@section('content')
    <main class="top-nav-padding">
            ...
            <div class="responsive-block">
                <div class="banner-block responsive-item">
                    <div class="banner-bg hidden-sm-down"
                        style="background-image: url('/images/liber-v/avita-liber-v-web-new-v4.jpg')"></div>
                    <div class="banner-bg hidden-md-up"
                        style="background-image: url('/images/liber-v/avita-liber-v-mob-new-v4.jpg')"></div>
                ...
                <div class="banner-para">
                    ...
                    <div class="banner-para text-center">
                        <span class="d-lg-block">
                            <span class="buy-now2"><a
                                    href="https://www.amazon.in/AVITA-NS14A8INF561-MB-35.56 cm-i5-10210U-Graphics/dp/B0873JP8WQ/"
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">Inspired by the neat geometric lines of La Muralla Roja (The Red
                                Wall) fortress in Spain, the perfect embodiment of Post-Modern architecture, LIBER V’s
                                design completely justifies its slogan ‘Limitless evolution’. Its high-quality webcam stands
                                out quite literally, perfectly completing the picture of a sleek and angular body with
                                pleasing aesthetics. LIBER V comes in 14 vibrant color options* encasing an ultra-slim
                                Aluminum build and equipped with an easy-to-open clip thereby achieving the trifecta of
                                design, durability and function.</span>
                        </div>
                    </div>
        ...
        <section class="product-liber-banner product-liber-v-banner">
            <div class="responsive-block">
                <div class="banner-bg hidden-sm-down"
                    style="background-image: url('/images/liber-v/AVITA_liber_v_banner_v2_hk_en.jpg')"></div>
                <div class="banner-bg hidden-md-up"
                    style="background-image: url('/images/liber-v/AVITA_liber_v_banner_v2_hk_en_mo.jpg')"></div>
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">Expand your vision with LIBER V’s 3.7 mm unbound ultra-narrow bezel
                                which gives its screen a larger viewing area compared to the previous LIBER notebooks. A
                                high screen to body ratio at 72.8% combined with an FHD 16:9 IPS anti-glare display allows
                                you to the stretch the limits of your viewing experience for an ultra-wide viewing angle of
                                178 degrees. Whether you are working or playing; indoors or outdoors, never miss any details
                                with the vibrant image feedback at a quite stable response time with LIBER V.</span>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="banner-info">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <span class="d-md-block">LIBER V boost its uniqueness as a personality statement accessory.
                            </span>
                ...
                <div class="container">
                    <div class="banner-info" style="background-image:none;">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <span class="d-md-block">easy to carry and ready to be unleashed with a snap and a
                                touch.</span>
                        </div>
                        <div class="banner-data d-flex flex-wrap text-left mx-auto pl-sm-5">
                            ...
                            <img class="bc-computer-image bc-computer-2" style="padding-top:20%;"
                ...
                <div class="container">
                    <div class="banner-info" style="background-image:none;">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <span class="d-md-block">performance parameter by adapting the new 10<sup>th</sup> Gen
                                Intel® </span>
                        ...
                        <div class="banner-data d-flex flex-column flex-sm-row flex-wrap justify-content-center justify-content-sm-between hidden-sm-down"
                            style="margin-top:0px;">


                            <div class="data-card my-3 text-left hidden-sm-down" style="padding-right: 100px;">
                                <div class="banner-header" style="font-size:1.5rem; opacity:0;">
                                    全尺寸背光鍵盤<br />特大觸控板<br />支援四指觸控</div>
                            </div>
