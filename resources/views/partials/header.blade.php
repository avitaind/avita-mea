            ...
            <ul class="navbar-nav mr-auto d-md-flex flex-md-row align-items-md-center justify-content-md-between">
                            ...
                            <li class="nav-item has-dropdown">
                                ...
                                <div class="dropdown">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="nav-item has-dropdown">
                                            <input id="liber_v_product" type="checkbox" hidden="">
                                            <a class="nav-link px-md-4 py-2">@lang('site.pura')</a>
                                            <div class="dropdown">
                                                <ul class="list-unstyled">
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="{{ route('product.overview', ['pura']) }}">@lang('site.pura-intel')</a>
                                                    </li>

                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="{{ route('product.overview', ['pura-amd']) }}">@lang('site.pura-amd')</a>
                                                    </li>
                                        ...
                                        <li class="nav-item has-dropdown">
                                            <input id="liber_v_product" type="checkbox" hidden="">
                                            <a class="nav-link px-md-4 py-2">@lang('site.essential_name')</a>
                                            <div class="dropdown">
                                                <ul class="list-unstyled">
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                    ...
                                                    <li class="nav-item has-dropdown">
                                                        <a class="nav-link px-md-4 py-2"
                                                            href="{{ route('product.overview', ['essential-premier']) }}">@lang('site.essential_premier')</a>
                                                    </li>
                ...
                {{-- <li class="nav-item has-dropdown">
                    ...
                    <a class="nav-link px-md-4 py-2"><label for="header_buy_online"
                            class="d-block mb-0">{{ app()->getLocale() }}</label></a>
                    <div class="dropdown">
                        <ul class="list-unstyled">
                            <li class="nav-item">
                                <a href="{{ url('locale/en') }}"><img src="{{ asset('images/en.jpg') }}"
                                        width="30px" height="20x"></i> ENGLISH</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('locale/hi') }}"><img src="{{ asset('images/hi.jpg') }}"
