    ...
    <div class="container">
        <div class="product-nav-toggler h2 text-center my-1 hidden-sm-up">
         ...
         <div class="product-nav-collapse">
            ...
            <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.overview', ['liber-v-amd']) }}">@lang('site.productnav_overview_liber_v_amd')</a></li>
            <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.spec', ['liber-v-amd']) }}">@lang('site.productnav_spec')</a></li>
