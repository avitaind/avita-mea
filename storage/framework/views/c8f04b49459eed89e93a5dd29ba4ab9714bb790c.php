    ...
    <main class="top-nav-padding">
        ...
        <section class="product-liber-computer ls-0" id="test" style="background-color:#eee;">
            <div class="container">
                <div class="banner-info" style="max-width:100%;">
                    ...
                    <div class="h2 banner-header mb-4 mb-sm-5" style="text-transform:uppercase;">All-Day Comfort．Essential
                        Performance</div>
        ...
        <section>
            <div class="banner-block ls-0">
                <div class="banner-bg hidden-sm-down"
                    style="background:url(/images/essential/essential_bg1_en.jpg) top center no-repeat;"></div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6" align="left">
                            ...
                            <div class="banner-para ls-0">Essential's Full HD IPS anti-glare display ensures comfortable,
                                distraction-free viewing from every angle while delivering vivid and authentic visuals in
                                pin-sharp detail. Housing a full-size keyboard, the compact laptop is designed for maximum
                                comfort regardless of the environment. Thanks to the comprehensive connection ports that go
                                with most peripherals, Essential offers unrivaled versatility that caters to your every
        ...
        <section>
            <div class="banner-block ls-0">
                <div class="banner-bg hidden-sm-down"
                    style="background:url(/images/essential/essential_bg2_en.jpg) top center no-repeat;"></div>
                <div class="banner-bg hidden-md-up" style="background-color:#fff;"></div>
                <div class="container">
                    <div class="space60 hidden-sm-down"></div>
                    <div class="space60 hidden-sm-down"></div>
                        ...
                        <div class="col-12 col-lg-6" align="left">
                            ...
                            <div class="ac-computer-wrap hidden-md-up">
                                <img class="ac-computer-image ac-computer-2" style=""
                                    src="/images/essential/essential_product.png"
                                    style="width: 700px;    margin-right: 150px;    margin-top: 200px;">
                            </div>
                            <div class="banner-para ls-0">Essential features an enormous capacity offered by the SATA SSD of
                                up to 256GB for faster data processing and near-instant booting up, making it a
                                work-friendly entry level laptop. With maximum power consumption as low as 2.6GHz, the
                                laptop promises excellent power efficiency and guarantees a battery life longer than ever.
                                Besides, the fan-less design eliminates distracting noises, allowing the device to run most
                                silently so you can stay focused on the tasks on hand. Coupled with professional design, the
                                unique cloth design of Matt White, Matt Black, and Concrete Grey is perfect for your home
                                life!</span></div>
                    ...
                    <div class="banner-info ls-0" style="text-align:left; min-height:950px;">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">Measuring merely 20mm for the 14" model, the lightweight,
                                effortlessly portable Essential is designed to accompany you wherever you go. The thin bezel
                            ...
                            <span class="d-lg-block"><a href="https://avita.com/mea/product/essential/spec"
                        ...
                        <div class="banner-data d-flex flex-column flex-sm-row flex-wrap justify-content-center justify-content-sm-between"
                            ...
                            <div class="data-card my-3 text-left">
                                ...
                                <div class="badge-caption"><a
                                        href="https://support.microsoft.com/en-my/help/4020089/windows-10-in-s-mode-faq"
        ...
        <section>
            <div class="banner-block ls-0">
                <div class="banner-bg hidden-sm-down"
                    style="background:url(/images/essential/essential_bg3_en.jpg) top center no-repeat;"></div>
                <div class="banner-bg hidden-md-up" style="background-color:#fff;"></div>
                <div class="container">
                    <div class="space60 hidden-sm-down"></div>
                    <div class="space60 hidden-sm-down"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6" align="left">
                            ...
                            <div class="banner-para ls-0">The 14" model comes with a full-sized screen for maximized
                                viewing comfort even after a long day of use. Its stunning performance and capabilities make
                                it an ideal device for everyday office work or an e-learning notebook for students.</span>
                            </div>
