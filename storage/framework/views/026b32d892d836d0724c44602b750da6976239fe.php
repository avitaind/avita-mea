...
<?php $__env->startSection('content'); ?>
    <main class="top-nav-padding">
        ...
        <section class="product-liber-banner">
            ...
            <a href="https://www.amazon.in/s?k=AVITA+PURA+AMD+R5">
        ...
        <span class="buy-now2"><a href="https://www.amazon.in/s?k=AVITA+PURA+AMD+R5">Buy Now</a></span>
           </div>
  <!--
                    <br/>
...
--->
        ...
        <section class="admiror-video" style="background-color:#fff;">
        	<div class="banner-block">
                <div class="container"> 
                 <div class="space30"></div> 
			    <iframe id="ytplayer" type="text/html" width="1110" height="630" src="/videos/PURA_clean_version2.mp4?controls=1&rel=0&showinfo=0&autoplay=1&loop=1&mute=1" frameborder="0" allowfullscreen></iframe> 
	            </div>
            </div>
            <div class="space60"></div>
             <div class="space30"></div>
                    ...
                    <div class="banner-info ls-0" style="text-align:left">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <div class="data-card my-3 text-left">
								...
								<div class="badge-value">R5-3500U</div>
                                <div class="badge-caption">AMD PROCESSOR</div>
                            </div>
                            <div class="data-card my-3 text-left">
                                <div class="badge-caption">Up to</div>
            ...
            <div class="container">
                ...
                <div class="row">
                	...
                	<div class="col-12 col-lg-6" align="left">
                    	<div class="h2 banner-header mob-text-center"><div class="d-sm-inline" style="text-transform:uppercase;">Light as a feather</div></div>
                		<div class="space60"></div>
                        <div class="ac-computer-wrap hidden-md-up">
                        ...
                        <div class="banner-para ls-0">
The 35.56 cm AVITA PURA embraces a super slim outfit and weighs from a mere 1.21kg, offering you unparalleled portability and ease of use.</span>                        </div>
        ...
        <section>
        <div class="banner-block" >
        <div class="banner-bg hidden-sm-down" style="background:url(/images/pura/pura_amd_bg2_hk.jpg) top center no-repeat;"></div>
            <div class="container">
                <div class="space60 hidden-sm-down"></div>
                <div class="space60"></div>
                <div class="row">
                	<div class="col-12 col-lg-6" align="left">
                    	<div class="h2 banner-header mob-text-center"><div class="d-sm-inline" style="text-transform:uppercase;">Always at your service</div></div>
...
<br />
The AVITA PURA is pre-installed with the Windows 10 Home Edition operating system (in S mode), along with the AMD Ryzen series R3-3200U or R5-3500U processor, up to 8GB RAM, 512GB SSD hard disk and various ports to meet your everyday needs.</span>                        </div>
                    </div>
                </div>
                <div class="space60 hidden-sm-down"></div>
                <div class="space60"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                	...
                	<div class="col-12 col-lg-8" align="center">
                    	<div class="h2 banner-header"><div class="d-sm-inline" style="text-transform:uppercase;">Exemplary experience</div></div>
                        <div>
