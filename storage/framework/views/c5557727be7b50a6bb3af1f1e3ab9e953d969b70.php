<div class="nav-product-panel">
    <div class="container">
        ...
        <div class="product-nav-collapse">
            ...
            <li class="nav-item"><a class="nav-link py-1" href="<?php echo e(route('product.overview', ['pura-amd'])); ?>"><?php echo app('translator')->getFromJson('site.pura-amd'); ?></a></li>
    <li class="nav-item"><a class="nav-link py-1" href="<?php echo e(route('product.spec', ['pura-amd'])); ?>"><?php echo app('translator')->getFromJson('site.productnav_spec'); ?></a></li>
