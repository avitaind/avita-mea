                ...
                <div class="banner-block s-banner">
                    <div class="banner-inner">
                        <div class="banner-wrap">
                            <a class="banner-bg" href="<?php echo e(route('product.overview', ['liber-v'])); ?>"
                                style="background-image: url('/images/demo/<?php echo app('translator')->getFromJson('site.home_photo1_image'); ?>')"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="banner-inner">
                        <div class="banner-wrap">
                            <a class="banner-bg" href="/aboutus"
                                style="background-image: url('/images/demo/<?php echo app('translator')->getFromJson('site.home_photo3_image'); ?>')"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="banner-inner">
                        <div class="banner-wrap">
                            ...
                            <a class="banner-bg" href="/support"
                                style="background-image: url('/images/demo/<?php echo app('translator')->getFromJson('site.home_photo4_image'); ?>')"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="col-12 col-sm-4 col-md-4">
                        <button class="btn btn-primary d-block mt-3 mt-sm-0 mt-md-0 mx-auto ml-md-3"
                            type="submit"><?php echo e(__('messages.home_subscribe')); ?></button>
                    </div>
                </div>
            </div>
